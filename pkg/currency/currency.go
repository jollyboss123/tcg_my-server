...
func (c Currencies) CurrencyByCode(code string, logger *slog.Logger) (*Currency, error) {
	sc, ok := c[strings.ToUpper(code)]
	if !ok {
		logger.Error("fetch currency", slog.String("error", ErrCurrencyNotFound.Error()), slog.String("code", code))
...
var currencies = Currencies{
	...
	HKD: {Decimal: ".", Thousand: ",", Code: HKD, Fraction: 2, NumericCode: "344", Grapheme: "$", Template: "$1"},
